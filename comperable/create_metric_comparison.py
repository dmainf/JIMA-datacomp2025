...
base_path = '/Users/dmainf/lab/datacomp_2025/comperable'
tft_df = pd.read_csv(f'{base_path}/tft/evaluation_by_book.csv')
chronos_df = pd.read_csv(f'{base_path}/chronos_t5/evaluation_by_book.csv')
chronos_ft_df = pd.read_csv(f'{base_path}/chronos_t5+FT/evaluation_by_book.csv')
chronos_bolt_df = pd.read_csv(f'{base_path}/chronos_bolt/evaluation_by_book.csv')
chronos_bolt_ft_df = pd.read_csv(f'{base_path}/chronos_bolt+FT/evaluation_by_book.csv')
